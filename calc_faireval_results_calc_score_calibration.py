...
if __name__ == '__main__':
    ...
    parser.add_argument("--human_results_path", default="./agentverse/tasks/llm_eval/data/faireval/preprocessed_data"
                                                        "/test.json")
    parser.add_argument("--model_results_path",
                        default="./outputs/llm_eval/multi_role/only_static_assign/faireval/five_turns_sequential/two_different_role/calc_score_comparison/gpt_35_0301")
    parser.add_argument("--model_results_reverse_path",
                        default="./outputs/llm_eval/multi_role/only_static_assign/faireval/five_turns_sequential/two_different_role/calc_score_comparison_reverse/gpt_35_0301")
